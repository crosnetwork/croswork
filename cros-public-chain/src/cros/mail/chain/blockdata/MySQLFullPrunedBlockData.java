...
public class MySQLFullPrunedBlockData extends DatabaseFullPrunedBlockData {
	...
	public MySQLFullPrunedBlockData(NetworkParams params, int fullStoreDepth, String hostname, String dbName,
			String username, String password) throws BlockDataException {
